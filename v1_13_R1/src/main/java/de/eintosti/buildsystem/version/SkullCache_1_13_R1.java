 ...
 * @author einTosti
 */
public class SkullCache_1_13_R1 implements SkullCache {
    private final Map<String, net.minecraft.server.v1_13_R1.ItemStack> skullCache;

    public SkullCache_1_13_R1() {
