 ...
 * @author einTosti
 */
public class Sidebar_1_13_R1 extends Placeholders implements Sidebar {
    ...
    public Sidebar_1_13_R1(String title, List<String> body) {
        this.title = title;
        this.body = body;
    ...
    private void forceUpdate(Player player, String... information) {
        ...
        for (int i = 0; i < scoreboardLines; i++) {
            ...
            PacketPlayOutScoreboardScore packetPlayOutScoreboardScore = new PacketPlayOutScoreboardScore(ScoreboardServer.Action.CHANGE, objective
                    .getName(), text, scoreboardScore.getScore());
