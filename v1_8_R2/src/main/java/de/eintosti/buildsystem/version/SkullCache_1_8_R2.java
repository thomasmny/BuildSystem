 ...
 * @author einTosti
 */
public class SkullCache_1_8_R2 implements SkullCache {
    private final Map<String, net.minecraft.server.v1_8_R2.ItemStack> skullCache;

    public SkullCache_1_8_R2() {
    ...
    public ItemStack getCachedSkull(String name) {
        net.minecraft.server.v1_8_R2.ItemStack cachedSkull = this.skullCache.get(name);
