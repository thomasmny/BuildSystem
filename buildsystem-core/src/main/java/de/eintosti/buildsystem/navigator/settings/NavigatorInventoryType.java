...
public enum NavigatorInventoryType {
    ...
    /**
     * When opening the {@link NavigatorType#NEW} navigator, each armor stand has a custom name which is unique for every player and each {@link NavigatorInventoryType}.<br> Gets
     * said name.
     *
