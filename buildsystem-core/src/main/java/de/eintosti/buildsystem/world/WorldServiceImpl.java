...
public class WorldServiceImpl implements WorldService {
    ...
    /**
     * Unimport an existing {@link BuildWorldImpl}. In comparison to {@link #deleteWorld(Player, BuildWorldImpl)}, unimporting a world does not delete the world's directory.
     *
