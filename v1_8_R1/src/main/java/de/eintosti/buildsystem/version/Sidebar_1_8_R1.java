 ...
 * @author einTosti
 */
public class Sidebar_1_8_R1 extends Placeholders implements Sidebar {
    ...
    public Sidebar_1_8_R1(String title, List<String> body) {
        this.title = title;
        this.body = body;
    ...
    public void update(Player player, boolean forceUpdate, String... information) {
        if (!forceUpdate) {
            ...
            for (Object score : scoreboard.getScores()) {
