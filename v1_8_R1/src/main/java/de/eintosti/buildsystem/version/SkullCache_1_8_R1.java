 ...
 * @author einTosti
 */
public class SkullCache_1_8_R1 implements SkullCache {
    private final Map<String, net.minecraft.server.v1_8_R1.ItemStack> skullCache;

    public SkullCache_1_8_R1() {
    ...
    public ItemStack getCachedSkull(String name) {
        net.minecraft.server.v1_8_R1.ItemStack cachedSkull = this.skullCache.get(name);
