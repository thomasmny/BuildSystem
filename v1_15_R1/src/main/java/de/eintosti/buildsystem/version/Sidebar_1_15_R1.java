 ...
 * @author einTosti
 */
public class Sidebar_1_15_R1 extends Placeholders implements Sidebar {
    ...
    public Sidebar_1_15_R1(String title, List<String> body) {
        this.title = title;
        this.body = body;
    ...
    public void set(Player player, String... information) {
        if (scoreboard.getObjective(SCOREBOARD_NAME) != null) {
            ...
            objective = scoreboard.registerObjective(SCOREBOARD_NAME, IScoreboardCriteria.DUMMY,
